    ...
    def print_rows(self, rows):
        for row in rows:
            if int(row[2]) <= 14 and int(row[3]) <= 14:
                print('REPORT: FAMILY: US10: Husband {} married his Wife {} married before either were at least 14 years of age.'.format(row[0], row[2]))
            elif int(row[2]) <= 14:
                print('REPORT: FAMILY: US10: Husband {} married his Wife {} married before Husband was at least 14 years of age.'.format(row[0], row[2]))
            elif int(row[4]) <= 14:
                print('REPORT: FAMILY: US10: Husband {} married his Wife {} married before Wife was at least 14 years of age.'.format(row[0], row[2]))
            else:
                pass
