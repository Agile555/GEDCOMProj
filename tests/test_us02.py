...
from modules.us02 import get_rows
...
def test_us02_02():
    ...
    assert get_rows(conn) == [('US02_T02_I01', '3000-01-01', '2000-01-01')]
...
def test_us02_04():
    ...
    assert get_rows(conn) == [('US02_T04_I01', '2000-01-01', '1000-01-01'), ('US02_T04_I02', '2000-01-01', '1000-01-01'), ('US02_T04_I03', '2000-01-01', '1000-01-01')]

def test_us02_05():
    execute_test('us02_05.ged', conn)
    assert get_rows(conn) == [('US02_T05_I03', '2000-01-01', '1000-01-01'), ('US02_T05_I04', '2000-01-01', '1000-01-01')]
