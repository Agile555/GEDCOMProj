...
def test_us03_01():
    execute_test('./ged/us03_01.ged', conn)
    assert get_rows(conn) == []

def test_us03_02():
    execute_test('./ged/us03_02.ged', conn)
    assert get_rows(conn) == [('US03_T02_I01', '2000-01-01', '1990-01-01')]

def test_us03_03():
    execute_test('./ged/us03_03.ged', conn)
...
def test_us03_04():
    execute_test('./ged/us03_04.ged', conn)
    assert get_rows(conn) == []

def test_us03_05():
    execute_test('./ged/us03_05.ged', conn)
